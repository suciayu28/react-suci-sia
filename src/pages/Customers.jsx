            ...
            {customerData.map((item) => (
              <tr key={item.id} className="border-b border-gray-50 hover:bg-gray-50 transition">
                ...
                <td className="p-4 text-sm font-medium text-gray-800">
                  ...
                  <Link to={`/customers/${item.id}`} className="text-emerald-400 hover:text-emerald-500">
                    {item.name}
                  </Link>
                ...
                <td className="p-4">
                  <span className={`px-3 py-1 rounded-full text-xs font-bold ${item.loyalty === 'Gold' ? 'bg-yellow-100 text-yellow-600' :
